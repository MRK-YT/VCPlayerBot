...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Mo_Tech_YT'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/MRK-YT/VCPlayerBot')
        ],
        [
    ...
    with suppress(MessageIdInvalid, MessageNotModified):
        ...
        if Config.DATABASE_URI and var in ["STARTUP_STREAM", "CHAT", "LOG_GROUP", "REPLY_MESSAGE", "DELAY", "RECORDING_DUMP"]:      
            ...
            if not value:
                ...
                await delete_messages([message, m])
            elif var in ["CHAT", "LOG_GROUP", "RECORDING_DUMP"]:
                try:
                    value=int(value)
                except:
